...
<template>
    <div class="h-full overflow-hidden flex flex-col bg-gray-100 white:bg-gray-900">
        <!-- Navigation -->
        <nav class="bg-white white:bg-gray-800 border-b border-gray-100 white:border-gray-700">
        ...
        <!-- Page Heading -->
        <header class="bg-white white:bg-gray-800 shadow" v-if="$slots.header">
