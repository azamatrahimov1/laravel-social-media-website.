...
<template>
    <div class="py-6">
        <div @click="postCreating = true" class="py-3 px-2 text-gray-500 border border-gray-300 rounded-mb mb-3">
        ...
        <div v-if="postCreating" class="flex gap-2 justify-between">
            <button type="submit"
                ...
                Attach Files
                <input type="file" class="absolute lest-0 right-0 bottom-0 opacity-0">
            </button>
            <button type="submit"
